...
<body>
    ...
    <div class="content shadow">
        <h1 class="title">Blues</h1>
        <div class="concerts">
            <a href="scottConcert.html" class="container1">
                <img src="images/blues/scotthbiram.png" alt="Scott H' Biram" class="image1">
                <div class="overlay1">
                    <div class="text1">Scott H' Biram <br> click for more </div>
                </div>
            </a>
            <a href="bonJoviConcert.html" class="container1">
                <img src="images/rock/bonjovi.png" alt="Bon Jovi" class="image1">
                <div class="overlay1">
                    <div class="text1">Bon Jovi <br> click for more </div>
                </div>
            </a>
            <a href="eltonJohnConcert.html" class="container1">

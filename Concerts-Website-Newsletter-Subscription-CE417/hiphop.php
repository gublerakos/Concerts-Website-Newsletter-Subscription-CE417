...
<body>
    ...
    <div class="content shadow">
        <h1 class="title">Hip Hop</h1>
        <div class="concerts">
            <a href="eminem.php" class="container1">
                <img src="images/hiphop/eminem.png" alt="Eminem" class="image1">
                <div class="overlay1">
                    <div class="text1">Eminem <br> click for more </div>
                </div>
            </a>
            <a href="yg.php" class="container1">
                <img src="images/hiphop/yg.png" alt="YG" class="image1">
                <div class="overlay1">
                    <div class="text1">YG <br> click for more </div>
                </div>
            </a>
            <a href="bloodyHawk.php" class="container1">
                <img src="images/hiphop/bloodyHawk.png" alt="Bloody Hawk" class="image1">
                <div class="overlay1">
                    <div class="text1">Bloody Hawk <br> click for more </div>
                </div>
            </a>
            <a href="12pithikos.php" class="container1">
                <img src="images/hiphop/12pithikos.png" alt="12pithikos" class="image1">
                <div class="overlay1">
                    <div class="text1">12 Pithikos <br> click for more </div>
                </div>
            </a>
        </div>
        <br><br><br><br><br>
